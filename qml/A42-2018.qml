...
<qgis minScale="100000000" maxScale="0" simplifyMaxScale="1" simplifyDrawingTol="1" simplifyAlgorithm="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Rendering|CustomProperties" simplifyDrawingHints="1" readOnly="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" version="3.28.7-Firenze" symbologyReferenceScale="-1">
      ...
      <symbol alpha="1" type="fill" force_rhr="0" frame_rate="10" is_animated="0" clip_to_extent="1" name="0">
        ...
        <layer class="SimpleFill" enabled="1" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="178,223,138,127" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
            <Option type="QString" value="178,223,138,255" name="outline_color"/>
  ...
  <aliases>
    ...
    <alias field="A42_003" index="2" name="行政区域コード"/>
    <alias field="A42_004" index="3" name="区域名称"/>
    <alias field="A42_005" index="4" name="当初都市計画決定年月日"/>
    <alias field="A42_006" index="5" name="最新都市計画変更年月日"/>
    <alias field="A42_007" index="6" name="面積"/>
    <alias field="A42_008" index="7" name="中心地緯度"/>
    <alias field="A42_009" index="8" name="中心地経度"/>
  </aliases>
  <defaults>
