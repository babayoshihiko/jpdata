...
<qgis styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Rendering|CustomProperties" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1" simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyLocal="1" readOnly="0" version="3.28.7-Firenze" simplifyDrawingTol="1" minScale="100000000" labelsEnabled="0" simplifyMaxScale="1">
      ...
      <symbol name="0" frame_rate="10" clip_to_extent="1" force_rhr="0" type="fill" alpha="1" is_animated="0">
        ...
        <layer locked="0" pass="0" class="PointPatternFill" enabled="1">
          <Option type="Map">
            ...
            <Option name="distance_y" type="QString" value="5"/>
            ...
            <Option name="seed" type="QString" value="936432793"/>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
          ...
          <symbol name="@0@0" frame_rate="10" clip_to_extent="1" force_rhr="0" type="marker" alpha="1" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="ET_Source" configurationFlags="None"/>
  ...
  <aliases>
    ...
    <alias name="" index="11" field="ET_ID"/>
    <alias name="" index="12" field="ET_Source"/>
  ...
  <defaults>
    ...
    <default expression="" field="ET_ID" applyOnUpdate="0"/>
    <default expression="" field="ET_Source" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" field="ET_ID" constraints="0"/>
    <constraint exp_strength="0" unique_strength="0" notnull_strength="0" field="ET_Source" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="ET_Source"/>
