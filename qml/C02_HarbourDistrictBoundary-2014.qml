...
<qgis hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyLocal="1" symbologyReferenceScale="-1" version="3.28.7-Firenze" labelsEnabled="0" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" simplifyAlgorithm="0" maxScale="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Rendering|CustomProperties">
  ...
  <fieldConfiguration>
    <field name="C12_014" configurationFlags="None">
    ...
    <field name="C12_015" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    <alias index="0" field="C12_014" name="都道府県コード"/>
    <alias index="1" field="C12_015" name="港湾コード"/>
  </aliases>
  <defaults>
    <default expression="" field="C12_014" applyOnUpdate="0"/>
    <default expression="" field="C12_015" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" field="C12_014" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" field="C12_015" exp_strength="0" constraints="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="C12_014" desc="" exp=""/>
    <constraint field="C12_015" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="C12_014"/>
    <field editable="1" name="C12_015"/>
  </editable>
  <labelOnTop>
    <field name="C12_014" labelOnTop="0"/>
    <field name="C12_015" labelOnTop="0"/>
  </labelOnTop>
  <reuseLastValue>
    <field name="C12_014" reuseLastValue="0"/>
    <field name="C12_015" reuseLastValue="0"/>
  </reuseLastValue>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>"C12_014"</previewExpression>
