...
<qgis styleCategories="Symbology" version="3.28.8-Firenze">
  <renderer-v2 enableorderby="0" type="categorizedSymbol" forceraster="0" referencescale="-1" attr="Type" symbollevels="0">
    <categories>
      <category symbol="0" label="航空機騒音障害防止地区" render="true" value="航空機騒音障害防止地区" type="string"/>
      <category symbol="1" label="航空機騒音障害防止特別地区" render="true" value="航空機騒音障害防止特別地区" type="string"/>
    </categories>
    <symbols>
      ...
      <symbol name="1" alpha="1" frame_rate="10" clip_to_extent="1" is_animated="0" type="fill" force_rhr="0">
        ...
        <layer class="LinePatternFill" locked="0" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="255,0,26,255"/>
          ...
          <symbol name="@1@0" alpha="1" frame_rate="10" clip_to_extent="1" is_animated="0" type="line" force_rhr="0">
            ...
            <layer class="SimpleLine" locked="0" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="draw_inside_polygon" type="QString" value="0"/>
                <Option name="joinstyle" type="QString" value="bevel"/>
                <Option name="line_color" type="QString" value="255,0,26,255"/>
                <Option name="line_style" type="QString" value="solid"/>
