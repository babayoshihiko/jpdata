...
class JPDataManager:
    ...
    def run(self):
        ...
        if self.ui:
            self.ui.init_tab1(self.land_info)
    ...
    def connect_signals(self):
        ...
        # Tab 3
        dw.myComboBox32.currentIndexChanged.connect(self._tab3_set_mesh)
        ...
        jpDataAddr.set_cb_prefs(dw.myCB_Addr_1)
        ...
        if os.path.exists(
            ...
            dw.myPB_Addr_1.setText(self.ui.tr("Jump"))
        else:
            dw.myPB_Addr_1.setText(self.ui.tr("Download"))
        dw.myPB_Addr_1.clicked.connect(self._myPB_Addr_1_clicked)
        ...
        self._downloader.progress.connect(dw.progressBar.setValue)
